...
<body>
    ...
    <div class="main_section">            
        <div class="slide">
            <div class="slide_buy">
                <img src="img/peperoni.png" class="pizza_buy img">
                <p class="desc_text text_buy">
                    <?php
                        
                        $stmt = $conn->query("SELECT name, price, opis, ingredients FROM pizza INNER JOIN pizza_ingredients ON pizza_ingredients.id = pizza.ingredient WHERE pizza.id=2");
                    ...
                    <form action="buy.php" method="post">
                        <input type="text" value="2" style="visibility: hidden;">
