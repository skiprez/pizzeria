...
<body>
    ...
    <div class="main_section">            
        <div class="slide">
            <div class="slide_buy">
                <img src="img/capricciosa.png" class="pizza_buy img">
                <p class="desc_text text_buy">
                    <?php
                        
                        $stmt = $conn->query("SELECT name, price, opis, ingredients FROM pizza INNER JOIN pizza_ingredients ON pizza_ingredients.id = pizza.ingredient WHERE pizza.id=4");
                    ...
                    <form action="buy.php" method="post">
                        <input type="text" value="4" style="visibility: hidden;">
